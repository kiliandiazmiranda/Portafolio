...
export const PERSONAL_INFO = {
  ...
  stats: [
    { label: "Áreas de Dominio", value: "6", change: "Full-Stack" },
    { label: "Perfil GitHub", value: "Activo", change: "Código abierto" },
    { label: "Investigador", value: "ORCID", change: "0009-0008-5635-4111" },
    { label: "Enfoque", value: "Desarrollo Web", change: "Código limpio y mantenible" },
  ]
};
...
export const SKILL_CATEGORIES: SkillCategory[] = [
  {
    ...
    title: "Lenguajes",
    description:
      "Lenguajes utilizados para el desarrollo de aplicaciones web, automatizaciones y gestión de datos.",
    iconName: "Code2",
    color:
  ...
  },
  {
    ...
    title: "Frontend",
    description:
      "Desarrollo de aplicaciones web modernas, enfocadas en crear experiencias digitales funcionales, interactivas y eficientes.",
    iconName: "Layout",
    color:
  ...
  },
  {
    ...
    title: "Backend",
    description:
      "Desarrollo de servicios y soluciones del lado del servidor para gestionar la lógica, funcionalidades y comunicación de aplicaciones web.",
    iconName: "Server",
    color:
  ...
  },
  {
    ...
    description:
      "Gestión y consulta de bases de datos relacionales y NoSQL mediante herramientas y tecnologías especializadas.",
    iconName: "Database",
    color:
      "from-cyan-500/10 to-blue-500/10 text-cyan-600 dark:text-cyan-400",
    technologies: [
  ...
  {
    id: "testing_and_cloud",
    number: "05",
    title: "Pruebas y Cloud",
    description:
      "Creación de pruebas automatizadas y uso de plataformas en la nube para el despliegue y administración de aplicaciones.",
    iconName: "Cloud",
    color:
  ...
  },
  {
    ...
    description:
      "Herramientas de desarrollo y uso de modelos de inteligencia artificial para apoyar y optimizar diferentes procesos.",
    iconName: "Bot",
    color:
