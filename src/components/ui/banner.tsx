// Componente de integracion para el banner del campo Keep Android Open
...
export const Banner: React.FC = () => {
  ...
  return (
    <aside
      ...
      className="w-full max-w-4xl mx-auto px-4 sm:px-6 mt-10 sm:mt-12 mb-6 sm:mb-8 relative z-10 transition-all duration-300"
    >
      <div
...
export { Banner as KeepAndroidOpenBanner };
