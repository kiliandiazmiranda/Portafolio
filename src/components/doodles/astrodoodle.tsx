// Ilustraciones vectoriales SVG estilo doodle de cuerpos celestes y objetos astronomicos
...
export const AstronomyDoodle: React.FC<AstronomyDoodleProps> = ({
  ...
  switch (id) {
    ...
    case 'galaxia':
      // 7. Svg Galaxia de Andrómeda (M31)
      return (
        <svg
          viewBox="0 0 160 140"
          className={`${className} ${wobbleClass}`}
    ...
    case 'blackhole':
    case 'sagitario':
      // 8. Svg Agujero Negro Supermasivo (Sagitario A*)
      return (
        <svg
          viewBox="0 0 160 140"
          className={`${className} ${wobbleClass}`}
...
export { AstronomyDoodle as AstroDoodle };
