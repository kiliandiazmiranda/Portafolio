// Modal interactivo del observatorio

import React, { useState, useEffect, useRef } from 'react';
import { X } from 'lucide-react';
import { ASTRONOMY_OBJECTS } from '../../data/portfolio';
import { AstronomyDoodle } from '../doodles/astrodoodle';
import {
  DoodleTelescope,
  DoodlePlanet,
  DoodleRadar,
...
export { AstroModal as AstronomyModal };
