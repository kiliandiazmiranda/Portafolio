// Modal interactivo de criaturas prehistoricas

import React, { useState, useEffect, useRef, useMemo } from 'react';
import { X } from 'lucide-react';
import { PREHISTORIC_CREATURES } from '../../data/portfolio';
...
// Estado del lienzo Doodle con historial de deshacer/rehacer, deslizador de intensidad y exportación a PNG
  ...
  const handleExportPNG = () => {
    ...
    exportCtx.fillText('🦖 Boceto Doodle Prehistórico', exportCanvas.width - 18, exportCanvas.height - 18);
