// Seccion de publicaciones academicas de ORCID
...
import { fetchOrcidWorks, FetchOrcidResult } from '../../services/orcidapi';
import { PERSONAL_INFO } from '../../data/portfolio';
import { DoodleBook } from '../doodles/icons';
...
export const Orcid: React.FC = () => {
  ...
  return (
    <section id="orcid" ref={sectionRef} className="pt-1 sm:pt-2 pb-10 sm:pb-14 border-b border-neutral-200/60 dark:border-neutral-800/60">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden sm:flex items-center gap-2 rotate-[2deg] select-none pointer-events-none text-neutral-700 dark:text-neutral-300">
              <div className="font-crayon text-xs sm:text-sm text-right leading-tight">
                <span className="text-sky-700 dark:text-sky-400 font-bold">/*</span> DOI indexado <span className="text-sky-700 dark:text-sky-400 font-bold">*/</span>
              </div>
              <svg className="w-10 h-4 text-sky-600/60 dark:text-sky-400/60" viewBox="0 0 48 20" fill="none">
