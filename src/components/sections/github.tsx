// Seccion de repositorios publicos de GitHub 
...
export const Github: React.FC = () => {
  ...
  return (
    <section id="proyectos" ref={sectionRef} className="pt-1 sm:pt-2 pb-10 sm:pb-14 border-b border-neutral-200/60 dark:border-neutral-800/60">
      <div className="w-full">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-6 sm:mb-8 gap-3 sm:gap-4">
          <div className="flex items-center gap-4">
            ...
            <div className="hidden sm:flex items-center gap-2 rotate-[-2deg] select-none pointer-events-none text-neutral-700 dark:text-neutral-300">
              <div className="font-crayon text-xs sm:text-sm text-right leading-tight">
                <span className="text-emerald-700 dark:text-emerald-400 font-bold">*</span> git status <span className="text-sky-700 dark:text-sky-400 font-bold">(api sync)</span>
              </div>
                ...
                return (
                  ...
                  >
                    <div>
                      ...
                      <p className="text-sm sm:text-base text-neutral-800 dark:text-neutral-200 leading-relaxed mb-4 line-clamp-3 min-h-[46px] font-medium">
                        {repo.description}
                      </p>
                    </div>
                    ...
                    <div className="pt-4 border-t-2 border-dashed border-neutral-300 dark:border-neutral-800 space-y-3.5">
                      ...
                      {(() => {
                        ...
                        const hasPhoto = Boolean(
                          repo.preview_url &&
                          typeof repo.preview_url === 'string' &&
                          repo.preview_url.trim() !== ''
                        );
                          ...
                          return (
                            <div className="grid grid-cols-3 gap-2 pt-1">
                              <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="inline-flex items-center justify-center gap-1 px-2 py-2.5 doodle-btn doodle-shadow-sm text-xs sm:text-sm font-bold text-neutral-950 dark:text-neutral-50 bg-emerald-500/15 hover:bg-emerald-500/25 border-2 border-emerald-600/50 dark:border-emerald-500/50 transition-colors group/btn min-h-[42px]"
                                title="Ver página / Demo del proyecto"
                              >
                                <Globe className="w-4 h-4 text-emerald-700 dark:text-emerald-400 shrink-0" />
                                <span>Demo</span>
                                <ExternalLink className="w-3 h-3 opacity-70 group-hover/btn:opacity-100 transition-opacity hidden sm:inline-block" />
                              </a>

                              <a
                                href={repo.preview_url!}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="inline-flex items-center justify-center gap-1 px-2 py-2.5 doodle-btn doodle-shadow-sm text-xs sm:text-sm font-bold text-neutral-950 dark:text-neutral-50 bg-sky-500/15 hover:bg-sky-500/25 border-2 border-sky-600/50 dark:border-sky-500/50 transition-colors group/btn min-h-[42px]"
                                title="Ver foto / Captura de pantalla del proyecto"
                              >
                                <ImageIcon className="w-4 h-4 text-sky-700 dark:text-sky-400 shrink-0" />
                                <span>Foto</span>
                                <ExternalLink className="w-3 h-3 opacity-70 group-hover/btn:opacity-100 transition-opacity hidden sm:inline-block" />
                              </a>
                          ...
                          return (
                            <div className="grid grid-cols-2 gap-2.5 pt-1">
                              <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="inline-flex items-center justify-center gap-1.5 px-4 py-2.5 doodle-btn doodle-shadow-sm text-xs sm:text-sm font-bold text-neutral-950 dark:text-neutral-50 bg-sky-500/15 hover:bg-sky-500/25 border-2 border-sky-600/50 dark:border-sky-500/50 transition-colors group/btn min-h-[42px]"
                                title="Ver foto / Captura de pantalla del proyecto"
                              >
                                <ImageIcon className="w-4 h-4 text-sky-700 dark:text-sky-400" />
                                <span>Foto</span>
                                <ExternalLink className="w-3.5 h-3.5 opacity-70 group-hover/btn:opacity-100 transition-opacity" />
                              </a>
...
export { Github as GithubRepos, Github as GithubReposSection };
